...
#    bash <(curl -s https://raw.githubusercontent.com/sxbai/shuxia/main/install-wordpress-on-replit.sh)

echo "准备在您的 Replit 中安装 Wordpress"
echo "您是否确保在运行此脚本之前配置了 replit.nix 文件？"

#配置 replit.nix 文件
curl -LG https://raw.githubusercontent.com/sxbai/shuxia/main/replit.nix > ./replit.nix
...
curl -LG https://raw.githubusercontent.com/sxbai/shuxia/main/db.php > ./wp-content/db.php
